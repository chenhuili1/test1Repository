...
IMC_API DWORD WINAPI IMC_GetPWOffset(IMC_HANDLE Handle);
IMC_API IMC_STATUS WINAPI  IMC_ReserveWEB(IMC_HANDLE Handle,DWORD addr,DWORD fplength,char * Buff );
IMC_API IMC_STATUS WINAPI IMC_ReserveREB(IMC_HANDLE Handle,DWORD addr,char * Buff,DWORD length);
IMC_API IMC_STATUS WINAPI IMC_ReserveEP(IMC_HANDLE Handle,DWORD page);//擦除页函数
