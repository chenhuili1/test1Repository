...
//	#define contourmod1Loc			365 	//G		F16	
	...
	//参与路径运动的轴数
	#define pathaxisnum1Loc			370		//G		U16		
	//映射为X轴的轴号
	#define segmap_x1Loc			371		//G		U16		
	//映射为Y轴的轴号
	#define segmap_y1Loc			372		//G		U16		
	//映射为Z轴的轴号
	#define segmap_z1Loc			373		//G		U16		
	//映射为A轴的轴号
	#define segmap_a1Loc			374		//G		U16		
	//映射为B轴的轴号
	#define segmap_b1Loc			375		//G		U16		
	//映射为C轴的轴号
	#define segmap_c1Loc			376		//G		U16						
	//映射为D轴的轴号
	#define segmap_d1Loc			377		//G		U16							
	//映射为E轴的轴号											
	#define segmap_e1Loc			378		//G		U16			
	//映射为F轴的轴号					
	#define segmap_f1Loc			379		//G		U16	
	//映射为G轴的轴号						
	#define segmap_g1Loc			380		//G		U16		
	//映射为H轴的轴号					
	#define segmap_h1Loc			381		//G		U16	
	//映射为I轴的轴号					
	#define segmap_i1Loc			382		//G		U16		
	//映射为J轴的轴号					
	#define segmap_j1Loc			383		//G		U16		
	//映射为K轴的轴号						
	#define segmap_k1Loc			384		//G		U16	
	//映射为L轴的轴号						
	#define segmap_l1Loc			385		//G		U16		
	//映射为M轴的轴号
	#define segmap_m1Loc			386		//G		U16	
	//段执行的目标速度
...
//	#define contourmod2Loc			418 	//G		F16		
	...
	#define gioLoc				560		//G		R16	

	//全局开关量输出gout2
	#define gout2Loc			561		//G		R16
	#define xgioLoc				561		//G		R16	
